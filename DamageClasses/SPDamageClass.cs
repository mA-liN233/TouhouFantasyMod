...
namespace TouhouFantasyMod.DamageClasses
{
	public class SPDamageClass : DamageClass
	{
		public override void SetStaticDefaults()
		{
			ClassName.SetDefault("灵力伤害");
		}

		protected override float GetBenefitFrom(DamageClass SPDamageClass)
		{
			...
			if (SPDamageClass == DamageClass.Generic)
				return 1f;
			...
			*/
			...
			if (SPDamageClass == DamageClass.Magic)
				return 5f;
		...
		public override bool CountsAs(DamageClass SPDamageClass)
		{
